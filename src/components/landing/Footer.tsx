        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          <div className="space-y-6">
            <div className="flex items-center gap-2">
              ...
              <div>
                <span className="font-heading font-bold text-xl block leading-none">Pitman</span>
                <span className="text-sm font-medium text-indigo-500">Odor Neutralization Pros</span>
              </div>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li><a href="#services" className="text-slate-400 hover:text-indigo-500 transition-colors flex items-center gap-2 font-medium"> Molecular Decontamination</a></li>
              <li><a href="#services" className="text-slate-400 hover:text-indigo-500 transition-colors flex items-center gap-2 font-medium"> Hydroxyl Odor Removal</a></li>
              <li><a href="#services" className="text-slate-400 hover:text-indigo-500 transition-colors flex items-center gap-2 font-medium"> Bio-Enzyme Treatment</a></li>
              <li><a href="#services" className="text-slate-400 hover:text-indigo-500 transition-colors flex items-center gap-2 font-medium"> HEPA Air Scrubbing</a></li>
              <li><a href="#services" className="text-slate-400 hover:text-indigo-500 transition-colors flex items-center gap-2 font-medium"> Source Diagnostics</a></li>
            </ul>
          </div>
          ...
          <div className="space-y-8">
            <h4 className="text-lg font-bold mb-8 font-heading text-white">Pure Air Hotline</h4>
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <p className="text-slate-500 text-sm font-bold uppercase tracking-wider mb-1">Pitman Office</p>
